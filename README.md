...
> **Community Edition 3.15.2** — patch release aligning the public landing page footer with the release version.
...
GitHub Releases are created by `.github/workflows/release.yml` when a semantic version tag such as `v3.15.2` is pushed. The landing page is deployed by `.github/workflows/pages.yml`. A separate release workflow can publish the Community container to GHCR.
